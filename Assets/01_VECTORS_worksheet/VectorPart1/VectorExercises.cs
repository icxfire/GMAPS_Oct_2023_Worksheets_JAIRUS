...
public class VectorExercises : MonoBehaviour
{
    ...
    public void Question3b()
    {
        HVector2D a = new HVector2D(3, 5);
        HVector2D b = a * 2;
        HVector2D c = a / 2; // i use a new variable to compare the difference between the original a and divided one

        DebugExtension.DebugArrow(Vector3.zero, a.ToUnityVector3(), Color.red, 60f);
        DebugExtension.DebugArrow(new Vector3(1, 0, 0), b.ToUnityVector3(), Color.red, 60f);
    ...
    {
        HVector2D a = new HVector2D(3, 5);
        HVector2D b = new HVector2D(3, 5); // original vector to reference
        a.Normalize();
